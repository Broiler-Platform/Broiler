...
internal static class JSStringExtensions
{
    ...
    internal static JSString AsJSString(this JSValue v, [CallerMemberName] string helper = null)
    {
        if (v.IsNullOrUndefined)
            throw JSContext.NewTypeError($"String.prototype.{helper} called on null or undefined");
        ...
        throw JSContext.NewTypeError($"String.prototype.{helper} called with non string");
    }
