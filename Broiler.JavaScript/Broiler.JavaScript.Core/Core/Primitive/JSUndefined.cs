...
public sealed class JSUndefined : JSValue
{
...
#endif
            throw JSEngine.NewTypeError($"Cannot get property {name} of undefined");
        }
        set => throw JSEngine.NewTypeError($"Cannot set property {name} of undefined");
    }

    public override JSValue this[uint key]
    {
        get => throw JSEngine.NewTypeError($"Cannot get property {key} of undefined");
        set => throw JSEngine.NewTypeError($"Cannot set property {key} of undefined");
    }

    internal override JSFunctionDelegate GetMethod(in KeyString key) => throw JSEngine.NewTypeError($"Cannot get property {key} of undefined");
    ...
    public override JSValue CreateInstance(in Arguments a) => throw JSEngine.NewTypeError("cannot create instance of undefined");

    public override JSValue InvokeFunction(in Arguments a) => throw JSEngine.NewTypeError("undefined is not a function", null);

    public override IElementEnumerator GetElementEnumerator() => throw JSEngine.NewTypeError("undefined is not iterable");
