...
/// <summary>
/// Internal helpers that keep Core‐internal call sites working after the
/// public extension classes (ClrProxyExtensions, JSObjectExtensions,
/// JSPropertyExtensions, JSStringExtensions, MarshalExtensions) were moved
/// to the Broiler.JavaScript.Extensions assembly.
/// </summary>
internal static class InternalExtensionHelpers
{
    // ── JSObjectExtensions (AddProperty) ────────────────────────────

    [EditorBrowsable(EditorBrowsableState.Never)]
    internal static JSObject AddProperty(this JSObject target, in KeyString key, JSValue value, JSPropertyAttributes attributes = JSPropertyAttributes.EnumerableConfigurableValue)
    {
