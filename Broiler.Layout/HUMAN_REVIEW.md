...
- **Scope:** The CSS box-model and layout engine over the canonical DOM and computed styles.
...
- [ ] Build and automated tests completed; minimum expected commands: `dotnet test Broiler.Layout.Tests/Broiler.Layout.Tests.csproj`.
