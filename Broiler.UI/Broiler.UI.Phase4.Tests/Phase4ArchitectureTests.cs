...
public sealed class Phase4ArchitectureTests
{
    ...
    [
        ...
        [
            "Broiler.UI.Button.Standard/Broiler.UI.Button.Standard.csproj",
            new[]
            {
                "../../Broiler.Graphics/Broiler.Graphics/Broiler.Graphics.csproj",
                "../Broiler.UI.Button/Broiler.UI.Button.csproj",
        ...
        [
            "Broiler.UI.Edit/Broiler.UI.Edit.csproj",
            new[]
            {
                "../../Broiler.Graphics/Broiler.Graphics/Broiler.Graphics.csproj",
                "../Broiler.UI/Broiler.UI.csproj",
        ...
        [
            "Broiler.UI.Edit.Standard/Broiler.UI.Edit.Standard.csproj",
            new[]
            {
                "../../Broiler.Graphics/Broiler.Graphics/Broiler.Graphics.csproj",
                "../Broiler.UI.Edit/Broiler.UI.Edit.csproj",
    ...
    public void Phase4_Runtime_Projects_Target_Net10_And_Keep_Allowed_References(string relativeProjectPath, string[] expectedReferences)
    {
    ...
    {
        AssertConcreteControls(typeof(StandardButton).Assembly, typeof(StandardButton));
        AssertConcreteControls(typeof(StandardEdit).Assembly, typeof(StandardEdit));
    }

    [Fact]
    public void Abstraction_Assemblies_Expose_Abstract_Control_Bases()
    {
        Assert.True(typeof(UiButton).IsAbstract);
        Assert.True(typeof(UiEdit).IsAbstract);
    }

    [Fact]
    public void Phase4_Runtime_Assemblies_Do_Not_Expose_Native_Handles_Or_Windows_Types()
    {
        Assembly[] assemblies =
        [
            typeof(UiButton).Assembly,
            typeof(StandardButton).Assembly,
            typeof(UiEdit).Assembly,
