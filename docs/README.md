...
This index lists every document in `docs/` with a short summary and category.
Use it as the starting point for navigating project documentation.
...
| Document | Summary |
|----------|---------|
| [ADR Index](adr/README.md) | Architecture Decision Records (44 ADRs covering engines, modularisation, testing) |
