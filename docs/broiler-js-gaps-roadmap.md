...
| 6 | DOM, CSSOM, and SVG from JavaScript | Partial object and tree models; `compareDocumentPosition` retired as not reproducing | open · closed | Script-visible objects and algorithms meet their claimed standards |
