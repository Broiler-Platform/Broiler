...
| 5 | Essential browser JavaScript APIs | Mixed partial, absent, and stubbed surfaces; `performance.now()` monotonicity fixed | open · closed | A tested support matrix replaces accidental omissions |
