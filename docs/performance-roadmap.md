...
- **Provenance:** the pinned submodule pointer is **`14fa4f10`**, checked 2026-08-05 against
  ...
  **Five patches are pending again, and four of them are one item.**
  ...
  *not* name: a nested body **compiled a second time from the enclosing scope kept alive**, after
  ...
  And **[`0106`](../patches/0106-js-reentry-structural-partition.patch)** — that check's residual
...
empty for the second time since it was written. **Five patches are open again** (`0102`–`0106`: item 1-1's remaining
half in four of them — its capture-free population, its capture layout, a body compiled from a kept
enclosing scope, and that check's residual settled — plus the widened census corpus), on the usual
403 terms.
