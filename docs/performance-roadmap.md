...
- **`patches/` holds four open `Broiler.JS` patches — `0103`–`0106` — and everything else this
  ...
  execution-weighted numeric-tier refusals (`0106`) were committed against the pin, verified to
  apply to it **in order** with `git am --keep-cr`, and **could not be pushed**: `Broiler-Platform/Broiler.JS` is outside this
