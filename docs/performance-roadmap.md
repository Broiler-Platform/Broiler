...
- **`patches/` holds eight open `Broiler.JS` patches — `0103`–`0110` — and everything else this
  ...
  consumer-side boxing-read census (`0108`) the element-read widening (`0109`) and its root store arm (`0110`) were committed against the pin, verified to apply to it **in order** with `git am --keep-cr`, and **could not be pushed**: `Broiler-Platform/Broiler.JS` is outside this
