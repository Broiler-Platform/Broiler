...
- **Provenance:** the pinned submodule pointer is **`14fa4f10`**, checked 2026-08-05 against
  ...
  **Ten patches are pending again, and four of them are one item.**
  ...
  **[`0110`](../patches/0110-js-legacy-frame-census.patch)** — that frame **counted** rather
  ...
  And **[`0111`](../patches/0111-js-legacy-frame-shape.patch)** — that item's named fix **priced
...
empty for the second time since it was written. **Ten patches are open again** (`0102`–`0111`: item 1-1's remaining
