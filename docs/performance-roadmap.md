...
- **`patches/` holds six open `Broiler.JS` patches — `0103`–`0108` — and everything else this
  ...
  consumer-side boxing-read census (`0108`) were committed against the pin, verified to apply to it **in order** with `git am --keep-cr`, and **could not be pushed**: `Broiler-Platform/Broiler.JS` is outside this
