...
The phase that gates every other one, and the only one containing no engineering: harness readiness, the evidence still owed, and what the probe corpus caught on its first run.
