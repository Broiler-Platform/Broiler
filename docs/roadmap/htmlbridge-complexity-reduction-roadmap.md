...
| 8 — simplify Core and Scripting | **Started** | Item 3 delivered (P8.1, 2026-07-22): async-drain-limit exhaustion is now an explicit diagnostic (`ScriptEngine.AsyncDrainLimitExhausted` + warning) instead of a silent stop. Items 1, 2, 4, 5, 6 remain. See [remaining phases](htmlbridge-complexity-reduction-remaining.md). |
