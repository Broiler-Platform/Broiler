...
pre-fix produces **zero** with `0016` applied. Full analysis:
`docs/roadmap/wpt-1422-body-index-crash.md` (§ *2026-07-24 (later) — recurs as issue #1428* and
§ *root-cause found and fixed as `patches/0016`*).
