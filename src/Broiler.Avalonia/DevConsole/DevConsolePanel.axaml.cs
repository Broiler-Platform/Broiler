...
namespace Broiler.Avalonia.DevConsole;
...
public partial class DevConsolePanel : UserControl, IDisposable
{
    ...
    {
        if (DomTree.SelectedItem is TreeViewItem { Tag: BoxTreeNode node } && node.Box != null)
        {
    ...
    private void ShowBoxModel(CssBox box)
    {
        ...
        var canvasWidth = BoxModelCanvas.Bounds.Width > 0 ? BoxModelCanvas.Bounds.Width : DefaultCanvasWidth;
        var canvasHeight = BoxModelCanvas.Bounds.Height > 0 ? BoxModelCanvas.Bounds.Height : DefaultCanvasHeight;
    ...
    private void Tab_Checked(object? sender, RoutedEventArgs e)
    {
        ...
        DomPanel.IsVisible = false;
        JsPanel.IsVisible = false;
        ...
        switch (rb.Tag as string)
        {
            case "Log":
                ...
                break;
            case "Dom":
                DomPanel.IsVisible = true;
                break;
            case "Js":
                JsPanel.IsVisible = true;
                break;
        }
    }
